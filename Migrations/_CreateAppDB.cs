namespace CarMessenger.Migrations
{
    ...
    public partial class _CreateAppDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", o => o.userId, cascadeDelete: false, "LastSeenUserIdFK")
                //.ForeignKey("dbo.Messages", o => o.messageId, cascadeDelete: false, "LastSeenMessageIdFK")
                .ForeignKey("dbo.Chats", o => o.chatId, cascadeDelete: false, "LastSeenChatIdFK");

            Sql("ALTER TABLE [dbo].[LastSeens] WITH NOCHECK " +
                " ADD CONSTRAINT[LastSeenMessageIdFK] FOREIGN KEY([messageId]) REFERENCES[dbo].[Messages]([Id]) ON DELETE SET NULL; ");
        }
